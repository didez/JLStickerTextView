...
class ViewController: UIViewController {
    ...
    @IBAction func onRefreshColor(_: UIBarButtonItem) {
    ...
    @IBAction func onRefreshLineSpacing(_: UIBarButtonItem) {
        let index = arc4random_uniform(3)
    ...
    @IBAction func onRefreshFont(_: UIBarButtonItem) {
        let index = arc4random_uniform(3)
    ...
    @IBAction func onRefreshTextAlpha(_: UIBarButtonItem) {
        let index = arc4random_uniform(3)
    ...
    @IBAction func onAddLabel(_: UIBarButtonItem) {
        // Add the label
        stickerView.addImage()
        stickerView.currentlyEditingLabel.imageView?.image = UIImage(named: "cancel")
...
//        stickerView.currentlyEditingLabel.labelTextView?.becomeFirstResponder()
    ...
    @IBAction func onRefreshShadow(_: UIBarButtonItem) {
        let index = arc4random_uniform(3)
    ...
    @IBAction func onSaveImage(_: UIBarButtonItem) {
